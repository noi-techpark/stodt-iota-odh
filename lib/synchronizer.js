...
async function syncParking() {
    ...
    async.eachSeries(parking.stations, async function(station, outCb){
...
async function syncBluetooth() {
    // fetch newest informaiton from parking stations
    async.eachSeries(bluetooth.stations, async function(station, outCb){
...
async function syncEnvironment() {
    // fetch newest informaiton from parking stations
    async.eachSeries(environment.stations, async function(station, outCb){            
